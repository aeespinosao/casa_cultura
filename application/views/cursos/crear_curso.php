                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <!--<form id="" data-parsley-validate class="form-horizontal form-label-left">-->
                      <?php echo form_open('cursos/crear',array('class' => 'form-horizontal form-label-left', 'id' => 'crear_cursos')); ?>
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <input type="text" id="nombre" name="nombre" class="form-control col-md-7 col-xs-12" value="<?php echo $datos['nombre']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <input type="number" id="cupos" name="cupos"  class="form-control col-md-7 col-xs-12" value="<?php echo $datos['cupos']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <input type="number" id="clases" name="clases"  class="form-control col-md-7 col-xs-12" value="<?php echo $datos['clases']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <input id="horas" class="form-control col-md-7 col-xs-12" type="number" name="horas" value="<?php echo $datos['horas']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="control-group">
                            <div class="controls">
                              <div class="input-prepend input-group  col-sm-12">
                                <input type="text" name="fechas" id="reservation" class="form-control" value="<?php echo $datos['fechas']; ?>" />
                                ...
                                <div class="control-group">
                                  <div class="controls">
                                    <div class="col-sm-12 xdisplay_inputx form-group has-feedback" style="padding:0px; margin-bottom:0px;">
                                      <input name="fecha_limite" style="text-align:left; padding:6px 10px;"type="text" class="form-control has-feedback-left" id="single_cal3" placeholder="Fecha de nacimiento" aria-describedby="inputSuccess2Status3" value="<?php echo $datos['fecha_limite']; ?>">
                                      <span class="fa fa-calendar-o form-control-feedback right" aria-hidden="true"></span>
                                    </div>
                                  </div>
                                </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <input id="entidad" class="form-control col-md-7 col-xs-12" type="text" name="entidad" value="<?php echo $datos['entidad']; ?>">
                        </div>
                      </div>
                    <hr>
                      <div class="x_title">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <input type="text" id="doc_encargado" name="doc_encargado"  class="form-control col-md-7 col-xs-12" value="<?php echo $datos['doc_encargado']; ?>">
                        </div>
                      </div>
